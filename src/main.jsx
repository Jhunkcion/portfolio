...
function App() {
  return <>
    ...
    <main>
      ...
      <section className="intro section"><div className="section-label">01 — ABOUT</div><div className="intro-content"><h2>Developer by craft.<br /><span>Problem solver by nature.</span></h2><div><p>I work across frontend, backend, and mobile development, with a focus on clean interfaces, reliable systems, and practical engineering.</p><a className="text-link" href="#contact">More about me <span>↗</span></a></div></div></section>
